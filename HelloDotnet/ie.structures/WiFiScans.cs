...
namespace ie.structures.WiFiScans
{
    public class SAccessPointImpl : IeDelegate {
        ...
        public override string ToString() {
            return "SAccessPointImpl {Identifier: " + theIdentifier + ", SSID: " + theSSID + ", BSSID: " + theBSSID 
